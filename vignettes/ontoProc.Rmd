...
```{r lksco}
data(packDesc2022)
kable(packDesc2022[,-c(1,7)])
```
Other resources are listed in `packDesc2021` and `packDesc2019`.
...
```{r dosub, eval=TRUE}
cell_onto = ontoProc::getOnto("cellOnto", "2021")
...
print(as.data.frame(S4Vectors::mcols(AnnotationHub::query(ah, "ontoProcData"))))
#ef = getOnto("efoOnto")
