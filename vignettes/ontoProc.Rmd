...
library(knitr)
library(ontoProc)
go = getOnto( ontoname="goOnto", year_added = "2023" )
cl = getOnto( ontoname="cellOnto", year_added = "2022" )
pr = getOnto( ontoname="PROnto", year_added = "2023" )
...
```{r lklklk}
library(ontoProc)
cl = getOnto(ontoname="cellOnto", year = "2022")
...
```{r lkfa}
suppressMessages({
kable(CLfeats(cl, "CL:0002531", pr=pr))
})
```
