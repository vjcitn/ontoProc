...
The following table describes the most up-to-date resources available with `getOnto`. <!-- use inst/scripts/desc.R to generate all but the 'purpose' which is added by hand -->
